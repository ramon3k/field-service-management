...
IF NOT EXISTS (SELECT 1 FROM Companies WHERE CompanyCode = 'EXAMPLE')
BEGIN
    INSERT INTO Companies (CompanyCode, CompanyName, DisplayName, ContactEmail, IsActive, AllowServiceRequests)
    VALUES ('EXAMPLE', 'Example Field Services', 'Example Field Services', 'support@example.com', 1, 1);
...
IF NOT EXISTS (SELECT 1 FROM Users WHERE Username = 'admin' AND CompanyCode = 'EXAMPLE')
BEGIN
...
BEGIN
    ...
    WHERE Username = 'admin' AND CompanyCode = 'EXAMPLE';
